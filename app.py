...
def sitemap():
    ...
    site_url = "https://tayhu.uz" # Default fallback
...
def serve_react(path):
    ...
    try:
        ...
        seo_data = {
            'shopName': 'Tayhu',
            'title': 'Tayhu — Декоративный пластик и рейки | Ташкент',
            'description': 'Tayhu — интернет-магазин декоративного пластика, реек и 3D-панелей в Узбекистане.',
            'keywords': 'интерьер, декор, пластик, рейки, Узбекистан, интернет-магазин',
            'siteUrl': 'https://tayhu.uz',
            'language': 'ru'
        }
